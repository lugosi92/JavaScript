...
//Esperamos al evento actualziar vista 
    document.getElementById('vista-libros-boton').addEventListener("click", function() {
    
        //Obtenemos el valor del input
        let filtroVista = document.getElementById('vista-libros-incluye').value;
        
        //Verifico que el valor lo coge
        console.log(filtroVista);
    
        //Recorro todos los libros 1 por 21
            arrayLibros.forEach(libro => {
      
                //Verfico que con libro.titulo me imprime cada tiutulo
                console.log(libro.titulo); // One Piece
    
                //Si el titulo de cada libro contiene algo de el valor input
                if(libro.titulo.includes(filtroVista)){

                    //lo mete en arrayFuiltro para mostrar la vista actaulziada
...
// FUNCIÓN PARA MOSTRAR LIBROS EN LA TABLA FILTRADOS
